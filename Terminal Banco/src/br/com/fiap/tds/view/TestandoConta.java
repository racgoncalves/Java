...
public static void main(String args[]) {
		...
		do {
			...
			if (cc.testaUsuario(usuario) == false) {
			System.out.println("Usuário Inválido");
			}
		
		}while (cc.testaUsuario(usuario) == false);
		
		if (cc.testaUsuario(usuario) == true && cc.getBloqueado() == true) {
			System.out.println("Essa conta está bloqueda!!");
		}
		
		//Testa Senha
		
		else if (cc.testaUsuario(usuario) == true && cc.getBloqueado() == false) {
